...
const Register = () => {
    return ( 
        ...
        <div className="flex justify-center items-center text-center p-4">
          <div className="top-[8%] absolute text-gray-300t ">
            <h3 className="text-4xl font-bold">Welcome to T-Book</h3>
            <div className="px-4 py-6">
              ...
              <div className="flex justify-center items-center gap-3 py-2 mt-6 bg-gray-700 cursor-pointer">
                <FcGoogle />
              ...
              <div className="pt-10 pb-5 font-bold">
                <button className="border-2 border-gray-600 px-8 py-2">
                  Sign Up
                </button>
              </div>
              <p>
                Already register? <Link to="/auth/login" className="text-pink-700">
                  Login
                </Link>
              </p>
            </div>
